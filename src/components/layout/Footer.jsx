...
const Footer = () => {
  return (
    <footer className="footer w-100 flex flex-column justify-center align-center gap-1">
      ...
      <div className="socials flex flex-row justify-center align-center flex-wrap w-100 gap-2">
        <span>
        ...
        <span>
          <a target="_blank" href="https://www.linkedin.com/in/ahmad-salah-50519022a/">
