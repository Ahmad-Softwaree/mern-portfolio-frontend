  ...
  return (
    <>
      <AdminPath>
        {({}) => {
          return (
            <Card className="!w-full col-span-full md:col-span-6 !bg-black-600 !text-white-500">
              <CardHeader>
                <Flex spacing="4">
      ...
      <RootPath>
        {({}) => {
          return (
            <Link
              to={`/blogs/${val._id}`}
              className="col-span-full lg:col-span-4 relative flex flex-col justify-left items-start  gap-2  overflow-hidden w-full max-w-[350px] mx-auto shadow-xl bg-black-500 p-4   rounded-md  text-center text-white">
