...
import { DELETE_ONE_CERTIFICATE_METHOD } from "../../context/types/delete_types";
import { UPDATE_CERTIFICATE } from "../../context/types/ui_types";
export default function AdminCertificate({ val, index }) {
            ...
            <span
              onClick={() => {
                utilDispatch({
                  ...
                  payload: {
                    method: DELETE_ONE_CERTIFICATE_METHOD,
                    id: val._id,
                    image: val.imageName,
                  },
                });
