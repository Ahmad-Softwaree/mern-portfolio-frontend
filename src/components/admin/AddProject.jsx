...
import { addProject } from "../../context/actions/projectAction";
...
export default function AddProject() {
  ...
  return (
    ...
    >
      <h1 className="font-bold w-full text-center">Add Project</h1>
      ...
      <div className="w-full flex flex-row justify-center items-center gap-5">
        ...
        <button
          type="submit"
          disabled={addProjectLoading || uploadProjectImageLoading}
        ...
        >
          {addProjectLoading || uploadProjectImageLoading ? (
